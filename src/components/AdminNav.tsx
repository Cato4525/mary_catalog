...
export default function AdminNav({ hasSession }: { hasSession: boolean }) {
  ...
  return (
    <>
      ...
      {/* Mobile bottom nav - 4 essential links */}
      <nav className="fixed inset-x-0 bottom-0 z-50 border-t border-gray-200 bg-white/95 backdrop-blur-lg pb-[env(safe-area-inset-bottom,0px)] md:hidden">
